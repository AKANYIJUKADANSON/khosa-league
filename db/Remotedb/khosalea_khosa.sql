...
--
-- Host: localhost:3306
-- Generation Time: Dec 09, 2024 at 05:30 PM
...
(3, 'Elites', 'elites.png', 2004, '2004 is our year of entry, and cohort has every student who joined us from 2004-2009'),
...
(8, 'Matrix', 'matrix.png', 2015, 'It\'s a one heart desired team that selflessly plays and  has love for the league .. though facing some challenges'),
...
(10, '2K3Formidables', '2K3Formidables.png', 2003, 'Established in 2003, the 2K3Formidables took on the formidable name because they’re one since high school days. They’re frightening, diverse and capable.  Their  bond and unity is hard to break or defeat'),
...
CREATE TABLE `executives` (
  ...
  `team` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `image` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `link_twitter` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `link_facebook` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `link_instagram` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `link_whatsapp` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `link_linkedin` mediumtext COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Twesigomwe', 'David', 'President', '3', '6', '', 'chue.png', 'https://x.com/kirowyne', '', '', '', ''),
(2, 'Natasha', 'Rinah', 'Vice President', '2', '6', '', 'tagobya.png', 'https://x.com/NatashaRinah1', '', '', '', ''),
(3, 'Akatwijuka', 'Amon', 'Publicity', '2', '6', '', 'amon.png', 'https://x.com/AmonQs', '', '', '', ''),
(5, 'Twinamastiko', 'Bob', 'Technical', '2', '6', '', 'bob.png', 'https://x.com/bob_t_trukfit', '', '', '', ''),
(6, 'Kyokushaba', 'Shine', 'Ass. General Secretary', '2', '6', '', 'shine.png', '', '', '', '', ''),
(7, 'Kabalega', 'Edson', 'General Secretary', '3', '6', 'Historicals', 'kabalega.png', '', '', '', '', ''),
(8, 'Turyakira', 'Moses', 'Finance', '', '6', '', 'placeholder.jpg', '', '', '', '', '');
...
CREATE TABLE `fixtures` (
  ...
  `week` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `pitch` varchar(50) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(90, 'Omwokyi', 'Vegas', '2024-09-29', '3:00pm', 'Matchday 5', 'Pitch 1'),
(91, '2K3Formidables', 'Bulembia', '2024-09-29', '2:00pm', 'Matchday 5', 'Pitch 1'),
(92, 'Benghazi', 'Matrix', '2024-09-29', '2:30pm', 'Matchday 5', 'Pitch 1'),
(93, 'Warriors', 'Giggaz', '2024-09-29', '3:30pm', 'Matchday 5', 'Pitch 1'),
(94, 'Elites', 'Whizzy', '2024-09-29', '3:30pm', 'Matchday 5', 'Pitch 1'),
(95, 'Akasayi', 'Gwajwa', '2024-09-29', '2:30pm', 'Matchday 5', 'Pitch 1'),
(96, 'Karere', 'Historicals', '2024-09-29', '3:00pm', 'Matchday 5', 'Pitch 1'),
(97, 'Bulembia', 'Omwokyi', '2024-09-29', '4:30pm', 'Matchday 5', 'Pitch 2'),
(98, 'Matrix', 'Vegas', '2024-09-29', '5:00pm', 'Matchday 5', 'Pitch 2'),
(99, 'Giggaz', '2K3Formidables', '2024-09-29', '4:30pm', 'Matchday 5', 'Pitch 2'),
(100, 'Whizzy', 'Benghazi', '2024-09-29', '5:30pm', 'Matchday 5', 'Pitch 2'),
(101, 'Gwajwa', 'Warriors', '2024-09-29', '5:00pm', 'Matchday 5', 'Pitch 2'),
(102, 'Historicals', 'Elites', '2024-09-29', '2:00pm', 'Matchday 5', 'Pitch 2'),
(103, 'Karere', 'Akasayi', '2024-09-29', '5:30pm', 'Matchday 5', 'Pitch 2'),
(104, 'Omwokyi', 'Matrix', '2024-10-13', '3:00pm', 'Matchday 6', 'Pitch 1'),
(105, 'Bulembia', 'Giggaz', '2024-10-13', '2:30pm', 'Matchday 6', 'Pitch 1'),
(106, 'Vegas', 'Whizzy', '2024-10-13', '2:00pm', 'Matchday 6', 'Pitch 1'),
(107, '2K3Formidables', 'Gwajwa', '2024-10-13', '3:30pm', 'Matchday 6', 'Pitch 1'),
(108, 'Benghazi', 'Historicals', '2024-10-13', '2:00pm', 'Matchday 6', 'Pitch 1'),
(109, 'Warriors', 'Karere', '2024-10-13', '2:30pm', 'Matchday 6', 'Pitch 1'),
(110, 'Elites', 'Akasayi', '2024-10-13', '3:00pm', 'Matchday 6', 'Pitch 1'),
(111, 'Giggaz', 'Omwokyi', '2024-10-13', '4:30pm', 'Matchday 6', 'Pitch 2'),
(112, 'Whizzy', 'Matrix', '2024-10-13', '5:00pm', 'Matchday 6', 'Pitch 2'),
(113, 'Gwajwa', 'Bulembia', '2024-10-13', '5:30pm', 'Matchday 6', 'Pitch 2'),
(114, 'Historicals', 'Vegas', '2024-10-13', '3:30pm', 'Matchday 6', 'Pitch 2'),
(115, 'Karere', '2K3Formidables', '2024-10-13', '4:30pm', 'Matchday 6', 'Pitch 2'),
(116, 'Akasayi', 'Benghazi', '2024-10-13', '5:00pm', 'Matchday 6', 'Pitch 2'),
(117, 'Elites', 'Warriors', '2024-10-13', '5:30pm', 'Matchday 6', 'Pitch 2'),
...
CREATE TABLE `gallery` (
  ...
  `game_week` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `season` int NOT NULL,
  `filter_type` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `match_results` (
  ...
  `game_week` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `win_type` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Normal'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(32, 8, 1, 12, 1, '2024-09-01', 1, 0, 'Week3', 'Normal'),
...
CREATE TABLE `news` (
  ...
  `type` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'News'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `players` (
  `id` int NOT NULL,
  `image` varchar(200) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'placeholder.png',
...
(20, 'Niyonsaba_Brian.jpg', 4, 'KHS OB since 2008-2013', ' Niyonsaba Brian', 'Bulembia', ' Striker'),
(21, 'kwikiriza_wilson.jpg', 0, 'Agent of all seasons', 'Kwikiriza Wilson', 'Bulembia', 'Striker'),
(22, 'placeholder.jpg', 1, ' ---', 'Naamara Eric', 'Bulembia', 'Goal Keeper'),
...
(26, 'placeholder.jpg', 4, '-----', 'Francis', 'Bulembia', '-----'),
(27, 'placeholder.jpg', 5, '-----', 'Muhumuza Tom', 'Bulembia', '-----'),
(28, 'placeholder.jpg', 2, '-----', 'Ham', 'Bulembia', '-----'),
(29, 'placeholder.jpg', 2, '-----', 'Robbin', 'Bulembia', '-----'),
(30, 'Owence.jpg', 14, '---', 'Owence', 'Elites', 'Striker'),
(31, 'placeholder.jpg', 10, '---', ' Etoo', 'Elites', ' Striker'),
...
(42, 'arinda_kenneth.jpg', 5, 'Simplicity', 'Kenneth Arinda', 'Giggaz', 'Midfielder'),
(43, 'Bob_Twinamasiko.jpg', 3, 'I love playing football in the KHOSA LEAGUE for both health and social networking reasons', 'Bob Twinamasiko', 'Giggaz', ' Midfielder'),
...
(46, 'placeholder.jpg', 8, '-----', 'Donn muruta', 'Giggaz', '-----'),
...
(64, 'Mandela.jpg', 16, '--- ', 'Mandela Alex', 'Historicals', 'Striker'),
(65, 'placeholder.jpg', 6, '---', 'Kefa', 'Historicals', 'Striker'),
(66, 'placeholder.jpg', 7, '--- ', 'Simon', 'Historicals', 'Striker'),
...
(75, 'placeholder.jpg', 4, '-----', 'Atuheire Osbert', 'Historicals', '-----'),
(76, 'placeholder.jpg', 3, '-----', 'Joseph', 'Historicals', '-----'),
...
(110, 'placeholder.jpg', 4, '-----', 'Dickson', 'Vegas', '-----'),
(111, 'placeholder.jpg', 1, '-----', 'Allan', 'Vegas', '-----'),
(112, 'Herbert.jpg', 25, '---', 'Kajura Herbert', 'Warriors', 'Striker'),
(113, 'placeholder.jpg', 11, '---', ' Peter', 'Warriors', 'Striker'),
(114, 'placeholder.jpg', 8, 'Am the thinnest mukiga with the tallest mind on football ', 'Byarugaba Godet ', 'Warriors', 'Midfielder '),
...
(128, 'placeholder.jpg', 12, '---', 'Kendo Godwin', 'Whizzy', ' Striker'),
...
(142, 'placeholder.jpg', 4, '-----', 'Oscar', 'Historicals', 'Striker'),
(143, 'placeholder.jpg', 2, ' ---', 'Arinda Joshua', 'Gwajwa', 'Striker'),
(144, 'placeholder.jpg', 1, '-----', 'Cliff Fiat', 'Bulembia', '-----'),
(145, 'placeholder.jpg', 1, '-----', 'Bessus', 'Matrix', '-----'),
(146, 'placeholder.jpg', 1, '-----', 'Tonny', 'Elites', '-----'),
(147, 'placeholder.jpg', 1, '-----', 'Mark', 'Giggaz', '-----'),
(148, 'placeholder.jpg', 1, '-----', 'Dalton', 'Giggaz', '-----'),
(149, 'placeholder.jpg', 1, '-----', 'Ginny', 'Historicals', '-----');
...
CREATE TABLE `socialnews` (
  `id` int NOT NULL,
  `embed_link` longtext COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `sponsors` (
  `id` int NOT NULL,
  `sponsor` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `logo` varchar(225) COLLATE utf8mb4_general_ci NOT NULL,
  `team` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
